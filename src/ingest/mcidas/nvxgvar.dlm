...
C========================= END DIB11DOC ===========================
      ...
      DOUBLE PRECISION  SW1   , CW1   , SW3   , CW3   , GATT
      DOUBLE PRECISION  SUBLAT, SUBLON, SECS  , WA
      REAL              RPARMS(MXCDSZ)
      DOUBLE PRECISION  IMGTIM, EPOCH , TIMEX , TIME50, R     , B(3,3)
...
C IFUNC = 2
      ...
      REAL         YLAT  , YLON
      DOUBLE PRECISION   SUBLAT, SUBLON, EVLN  , SCPX  , TMPLAT, TMPLON
...
C ELUG ROUTINES USE DOUBLE PRECISION VARS; USE TEMP VARIABLES
      TMPLAT = ZLAT
      TMPLON = ZLON
...
C========================= END DIELCOMM ===========================
      ...
      INTEGER      IROUND, M0ITIME, LASDAY, LASTIM
...
C COMPUTE TIME IN MINUTES FROM JANUARY 1.0, 1950
      ...
      DOUBLE PRECISION FUNCTION GATT(K0,RPARMS,IPARMS,WA,TE)
...
C COMPUTE FRACTIONAL PIXEL NUMBER
      ...
      DOUBLE PRECISION FUNCTION EVLN(INSTR,RLINE)
...
C----------------------------------------------------------------
      ...
      DOUBLE PRECISION FUNCTION SCPX(INSTR,PIX)
